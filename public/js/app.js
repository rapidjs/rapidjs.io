...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Components_ClassBuilder__ = __webpack_require__(38);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Interface_TestModel__ = __webpack_require__(31);
//
//
//
//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_pluralize__ = __webpack_require__(37);
...
var Model = function () {
    function Model(config) {
        ...
        this.config = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.assignIn(defaults, config);

        if (!this.config.routes.model) {
            this.config.routes.model = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.kebabCase(this.config.modelName).replace('-', this.config.routeDelimeter);
        }

        if (!this.config.routes.collection) {
            this.config.routes.collection = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.kebabCase(__WEBPACK_IMPORTED_MODULE_2_pluralize___default()(this.config.modelName)).replace('-', this.config.routeDelimeter);
        }
    ...
    _createClass(Model, [{
        ...
        key: 'findBy',
        value: function findBy(key, value, data) {
            var route = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'model';
            var options = arguments[4];

            var urlParams = [route, key];
        ...
        key: 'findAllBy',
        value: function findAllBy(key, value, data, options) {
        ...
        value: function updateOrDelete(method) {
            ...
            return this.request(this.config.methods[method], (_makeUrl = this.makeUrl).call.apply(_makeUrl, [this].concat(urlParams)), data, options);
        }
    }, {
        key: 'create',
        ...
        value: function request(type, url) {
            ...
            if (['put', 'post', 'patch'].includes(type)) {
                data = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.assignIn(data, this.config.globalParameters);
                params.push(data);
                params.push(options);
            } else {
                options.params = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.assignIn(data, this.config.globalParameters);
                params.push(options);
            }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Model__ = __webpack_require__(30);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony default export */ __webpack_exports__["a"] = new TestModel({ baseURL: 'http://someapp.com' });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Vendor_prism__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Interface_TestModel__ = __webpack_require__(31);
...
window.rapidjs = {
    model: __WEBPACK_IMPORTED_MODULE_3__Interface_TestModel__["a" /* default */]
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(43)(module)))
