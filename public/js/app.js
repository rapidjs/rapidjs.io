...
/* harmony default export */ __webpack_exports__["a"] = new TestModel({ baseURL: 'http://someapp.com/api', modelName: 'TestModel', debug: true });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_qs__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_pluralize__ = __webpack_require__(43);
...
var Model = function () {
    ...
    _createClass(Model, [{
        ...
        value: function findBy(key, value, data, options) {
            ...
            return this.get(this.makeUrl.apply(this, urlParams), data, options);
        }
        ...
        key: 'hasRelationship',
        value: function hasRelationship(key, relation, data, requestOptions) {
            var url = this.makeUrl(key, relation);

            if (__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.isArray(relation)) {
                url = this.makeUrl.apply(this, [key].concat(_toConsumableArray(relation)));
            }
        ...
        value: function belongsTo(relation, key, data, keyValue, requestOptions) {
            ...
            return this.get((_any = this.any).makeUrl.apply(_any, urlParams), data, requestOptions);
        }
    }, {
        key: '_setLastUrl',
        value: function _setLastUrl(type, url) {
            var params = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

            if (['put', 'post', 'patch'].includes(type)) {
                this._debug.lastUrl = this.sanitizeUrl([this.baseURL, url].join('/')) + __WEBPACK_IMPORTED_MODULE_3_qs___default.a.stringify(params);
            } else {
                var urlParams = params.shift().params,
                    stringified = urlParams ? '?' + __WEBPACK_IMPORTED_MODULE_3_qs___default.a.stringify(urlParams) : '';
        ...
        key: '_setLastRequest',
        value: function _setLastRequest(type, url) {
        ...
        value: function rerun() {
            if (this._debug.lastRequest) {
                var _debug$lastRequest = this._debug.lastRequest,
                    type = _debug$lastRequest.type,
                    url = _debug$lastRequest.url,
                    data = _debug$lastRequest.data,
                    options = _debug$lastRequest.options;
        ...
        value: function request(type, url) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                (_api$type = _this.api[type]).call.apply(_api$type, [_this, _this.sanitizeUrl(url)].concat(params)).then(function (response) {
                    /**
...
window.rapidjs = __WEBPACK_IMPORTED_MODULE_3__Interface_TestModel__["a" /* default */];
